...
**12:40 — Paper draft attempt rolled back at the owner's request.** A one-shot full draft of `papers_drafts/ctt_iclr2027/` (the 12:29 entry, now removed) was reset out of the paper workspace and kept on its side branch `v1-draft-attempt`; the paper will be written section by section with the owner. The 11:10 scaffold stands.
