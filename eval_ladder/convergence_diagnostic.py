...
PRE-DECLARED BAR (fixed before any ic_gen score was seen):
  ...
  AMBIGUOUS  Δ in [1.0, 2.0) pp with a systematic sign -> also generate from ckpt-4000 and read
    ...
    python eval_ladder/convergence_diagnostic.py --mode gen-cmd
    # 2. plan + score those generations
    python eval_ladder/convergence_diagnostic.py --mode plan
    # 3. verdict
    python eval_ladder/convergence_diagnostic.py --mode report
"""
