...
# exp_082 (HumanVid bank): new output root + new plan filename. Everything else is the exp_081
# acceptance script unchanged. NOTE: the "exactly 800 x 10" incidence bar in the docstring is
# inherited — it re-reads n_ops/contents_per_op from the plan, so it follows whatever the
# pending advisor ruling sets in config_s2.yaml.
