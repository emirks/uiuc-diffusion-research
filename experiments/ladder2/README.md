...
sbatch experiments/ladder2/token_probe/job_probe.sbatch
python experiments/ladder2/train/token_verdict.py --apply

# 1. build (no GPU)
python experiments/ladder2/train/inventory.py         # rosters + latent coverage
python experiments/ladder2/build_registry.py          # registry.jsonl + 8 seatbelts
python experiments/ladder2/train/make_configs.py      # 12 training configs
pytest tests/test_ladder2_prompts.py -q

# 2. precompute (GPU)
sbatch --export=ALL,MODE=cond-clean ... experiments/ladder2/train/job_precompute.sbatch
sbatch --export=ALL,MODE=text       ... experiments/ladder2/train/job_precompute.sbatch
python experiments/ladder2/train/assemble_roots.py

# 3. train — pilot first, then the fleet
python experiments/ladder2/submit.py train --models spec_shadow_smoke,spec_color_rain
...
python experiments/ladder2/run_eval.py --mode plan
sbatch ... experiments/ladder2/job_score.sbatch
