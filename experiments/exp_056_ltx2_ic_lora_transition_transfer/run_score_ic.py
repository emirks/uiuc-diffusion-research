"""exp_056 scorer — exp_053 v2 fork with a singleton-style ceiling guard.
...
def main():
    ...
    with TeeLogger(run_dir / "run.log"):
        ...
        if cfg["wandb"]["enabled"]:
            try:
                import wandb
                run = wandb.init(project=cfg["wandb"]["project"], name=f"exp056_{args.label}",
                                 tags=["exp_056", "eval-harness", "ic-lora", args.label],
