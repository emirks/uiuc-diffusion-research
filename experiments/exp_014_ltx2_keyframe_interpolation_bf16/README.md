...
apt-get update -qq && apt-get install -y python3.10-dev

PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True python experiments/exp_014_ltx2_keyframe_interpolation_bf16/run.py
