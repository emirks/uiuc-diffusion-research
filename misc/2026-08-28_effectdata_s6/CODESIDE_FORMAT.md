...
rework (S1 restored · S6 re-paired same-shape · symlink trees → code-side). Companion to
`store/datasets/004_ctt_v2plus/meta.yaml` (the store entry) and `misc/2026-08-28_effectdata_s6/BUILD.md`
(S6 build). fable-advisor GO-WITH-CHANGES 2026-08-29, invariants 1–8.
